...
const MenuOptions = ['All', 'Nearby', 'Favorited'];

@connect()
export default class ArtworkListScreen extends React.Component {
  static route = {
    navigationBar: {
      visible: false,
    },
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {selectedOption === 'All' && <ArtworkList {...defaultListProps} />}
        {selectedOption === 'Nearby' && (
          <ArtworkList {...defaultListProps} nearby />
        )}
        {selectedOption === 'Favorited' && (
          <ArtworkList {...defaultListProps} favorited />
        )}
          ...
          <TouchableWithoutFeedback
            ...
            <View style={{ flexDirection: 'row' }}>
              <BoldText style={styles.navigationBarTitle}>
                {this.state.selectedOption} Artworks
              </BoldText>
